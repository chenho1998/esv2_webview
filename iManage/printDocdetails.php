    ...
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
       ...
       <body>
          <table style="width:100%;height:80px">
             ...
             <col width="80%">
             <tr>
                <td style="align-items:left;height:80px;vertical-align:middle;"> <img src="data:image/png;base64,@base64" width="120px" /> 
                </td>
                <td style="align-items:left;height:80px;">
                   <h4 style="line-height:18px;font-weight:bold;">@client<label class="small-text" style="margin-top:5px;">@sub_client</label></h4><p class="p-wo-margin">@address @city @state @zipcode</p><p class="p-wo-margin neg">Tel: @phone Fax: @fax</p><p class="p-wo-margin">E-mail: @email Website: @website</p>
                </td>
             </tr>
          </table>
          <div class="main-div">
             <h2 class="p-wo-margin">@doctype_caps</h2>
             ...
             <p class="p-wo-margin">Attn: @person_incharge</p>
             <p class="p-wo-margin">Tel: @cust_tel</p>
             <p class="p-wo-margin">Fax: @cust_fax</p>
             <hr style="margin:15px 0;">
             <table width="100%">
                <col width="15%">
                <col width="15%">
                ...
                <tr>
                   <td>
                      <label class="left-text"> Account </label>  
                   </td>
                   <td>
                      <label class="left-text"> Currency </label>  
                   </td>
                   <td></td>
                   <td></td>
                   <td>
                      <label class="left-text" style="margin-left:0px;"> Agent </label>  
                   </td>
                   <td style="text-align:left;">
                      <label class="left-text"> @doc_type No. </label>  
                   </td>
                   <td style="text-align:right;">
                        <label class="right-text"> Date </label>  
                   </td>
                </tr>
                <tr>
                   <td>
                      <p class="p-wo-margin left-text" style="font-weight:bold;"> @cust_code  </p>
                   </td>
                   <td>
                      <p class="p-wo-margin" style="font-weight:bold;"> RM  </p>
                   </td>
                   <td></td>
                   <td></td>
                   <td>
                      <p class="p-wo-margin" style="font-weight:bold;"> @staff_code  </p>
                   </td>
                   <td>
                      <p class="p-wo-margin left-text" style="font-weight:bold;"> @doc_code  </p>
                   </td>
                   <td style="text-align:right;">
                      <p class="p-wo-margin right-text" style="font-weight:bold;"> @doc_date  </p>
                   </td>
                </tr>
             </table>
             <hr style="margin:15px 0;">
             <table width="100%">
                ...
                <col width="10%">
                <tr class="spaceUnder">
                   <td class="small-text-womargin" style="width:2%;">No</td>
                   <td class="small-text-womargin" style="width:12.5%;">Item Code</td>
                   <td class="small-text-womargin" style="width:43%;">Description</td>
                   <td class="small-text-womargin" style="width:5%;text-align: center;" >Qty</td>
                   <td class="small-text-womargin" style="width:12.5%;text-align: center;">Price</td>
                   <td class="small-text-womargin" style="width:5%;text-align: center;">Discount</td>
                   <td class="small-text-womargin" style="width:12.5%;text-align: right;">Total</td>
                </tr>
                <tr class="spaceUnder">
                ...
                <tr class="spaceUnder">
                   ...
                   <td class="small-text-womargin"></td>
                   <td class="small-text-womargin"></td>
                   <td style="border-top:1px solid black;padding-top:10px;text-align: center;">@t_quantity</td>
                   <td class="small-text-womargin" style="text-align: center;"></td>
                   <td class="small-text-womargin" style="text-align: center;"></td>
                   <td class="small-text-womargin" style="text-align: right;"></td>
                </tr>
          ...
          <div>
             <table width="100%">
                ...
                <tr>
                   <td>
                      <p style="line-height:1em;" class="p-wo-margin">@in_word</p>
                   </td>
                   <td style="text-align: right;">
                      <p class="p-wo-margin">Total Payable</p>
                      <p class="p-wo-margin" style="font-weight:bold;">@total</p>
                   </td>
                </tr>
                <tr>
                   <td>
                      <p class="p-wo-margin" style="margin-top:1em;">Payment Terms:</p>
                      <p class="p-wo-margin">@term</p>
                   </td>
                   <td style="text-align: right;">
                      <p class="p-wo-margin" style="margin-top:1em;">Authorized Signature</p>
                      <p style="font-weight:bold;" class="p-wo-margin">@client</p>
                   </td>
                </tr>
             </table>
          </div>
...
if(
    ...
    for ($i=0; $i < count($details); $i++) { 
        $row = $details[$i];
        if(intval($row['quantity']) == 0 && $hide_zero_qty && $doc_type != 'receipt'){
            continue;
        }
        ...
        if(strpos($row['discount'], '%')  !== false){
            ...
            $row['discount'] = floatval($row['discount']) ? floatval($row['discount']) : '';
        }
