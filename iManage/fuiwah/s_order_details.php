...
<script>
    ...
    function openModal(ipad_item_id, product_code, unit_uom, quantity, unit_price, disc_1, disc_2, disc_3, salesperson_remark, discount_method, product_name){
        ...
        $.ajax({
            ...
            success: function(msg)
            {
                ...
                if(data){
                    $(".content").empty();
                    var view ="<p style='font-weight:bold;'>"+product_name+"</p><input class='numberic' style='width:32.6%;line-height:35px;margin-right:1%;' type='text' id='price' value="+unit_price+" placeholder='Price' onClick='this.select();'><input class='numberic' style='width:32.6%;line-height:35px;margin-right:1%;' type='text' id='quantity' value="+quantity+" placeholder='Quantity'>";
                    ...
                    var net_total = quantity;
                    var testing = '<?php echo $testing ?>';

                        view += "<br>"+discount;
                    if(testing == 1){
                        view+= "<table style='margin-top:1%;width:100%;padding: 0px;border-radius: 0px;' border='collapse'><tr><td style='width:50%;border:1px solid #bfa084;padding:5px;'>EXCHANGED</td><td style='width:50%;border:1px solid #bfa084;'><input class='numberic' style='border: 0px solid white; width: 100%; padding: 5px;' type='text' id='exchanged_qty' value='0' onkeyup='updateNetTotal()' onClick='this.select();'></td></tr><tr><td style='width:50%;border:1px solid #bfa084;padding:5px;'>REJECTED</td><td style='width:50%;border:1px solid #bfa084;'><input class='numberic' style='border: 0px solid white; width: 100%; padding: 5px;' type='text' id='rejected_qty' value='0' onkeyup='updateNetTotal()' onClick='this.select();'></td></tr><tr><td style='width:50%;border:1px solid #bfa084;padding:5px;'>LESS QTY</td><td style='width:50%;border:1px solid #bfa084;'><input class='numberic' style='border: 0px solid white; width: 100%; padding: 5px;' type='text' id='less_qty' value='0' onkeyup='updateNetTotal()' onClick='this.select();'></td></tr><tr><td style='width:50%;border:1px solid #000;padding:5px;background-color:#000; color:#fff; border-radius:0px;'>NET TOTAL</td><td style='width:50%;border:1px solid #000;border-radius:0px;'><input class='numberic' style='border: 0px solid white; width: 100%; padding: 5px;background-color:#000; color:#fff;border-radius:0px;' type='text' id='net_total' value='"+net_total+"' disabled></td></tr></table>";
    ...
    function updateNetTotal(){
        ...
        var net_total = parseInt(quantity) - parseInt(exchanged_qty) - parseInt(rejected_qty) - parseInt(less_qty);
        debugger;
        if(net_total != ''){
