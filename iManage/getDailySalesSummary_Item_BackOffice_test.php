    ...
    <div style="page-break-after: always;">
      <div>
        <div style="padding-bottom:15px;padding-top:20px;" />
          <h3 size="pixels" class="pixels">TOTAL PRICE: @totalprice</h3>
        </div>
...
if(
    ...
    $final_html = str_replace(array('@total_document_row','@totalprice'),array($summary_row,'RM'.number_format($total_price,2)),$final_html); 
